...
import MarketSync from '@/components/MarketSync'; // Import the wrapper
  ...
  export const metadata: Metadata = {
    ...
    title: 'Trade Dinaar Future of Trading',
    description: 'Trade Dinaar is the future of virtual trading, with live scanners and price alerts, also integration live algo trading with past portfolio',
    icons: {
      icon: '/favicon.ico',
      apple: [
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Trade Dinaar Open Graph Image',
        },
      ],
    },
    twitter: {
      ...
      images: [
        {
          ...
          width: 1200,
          height: 628,
          alt: 'Trade Dinaar Twitter Card Image',
        },
      ],
    }
  };
